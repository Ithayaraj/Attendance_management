      ...
      <div className="flex gap-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-slate-700/50 rounded-lg p-2 border border-slate-600">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-xl font-bold text-blue-400">{session.totalStudents}</div>
            ...
            <div className="bg-slate-700/50 rounded-lg p-2 border border-slate-600">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-xl font-bold text-red-400">{session.notAttending}</div>
        ...
        <div className="flex-shrink-0 w-36 flex flex-col">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <div className="bg-blue-600/20 rounded p-1.5 text-center border border-blue-500/30">
              <div className="text-lg font-bold text-blue-400">{attendingPercentage}%</div>
              <div className="text-xs text-slate-400">Attending</div>
            </div>
            <div className="bg-red-600/20 rounded p-1.5 text-center border border-red-500/30">
              <div className="text-lg font-bold text-red-400">{notAttendingPercentage}%</div>
              <div className="text-xs text-slate-400">Not Attending</div>
            </div>
          </div>
        </div>
